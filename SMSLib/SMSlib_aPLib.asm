...
;--------------------------------------------------------
	.area _CODE
;SMSlib_aPLib.c:21: void UNSAFE_SMS_loadaPLibcompressedTilesatAddr (const void *src, unsigned int dst) {
;	---------------------------------
; Function UNSAFE_SMS_loadaPLibcompressedTilesatAddr
; ---------------------------------
_UNSAFE_SMS_loadaPLibcompressedTilesatAddr::
;SMSlib_aPLib.c:416: __endasm;
	pop	bc
	pop	hl ; pop src
	pop	de ; pop dst
	push	de
