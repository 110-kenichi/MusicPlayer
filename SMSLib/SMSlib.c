...
void (*SMS_theVBlankInterruptHandler)(void) = nop;
...
void SMS_setVBlankInterruptHandler (void (*theHandlerFunction)(void)) __z88dk_fastcall {
  SMS_theVBlankInterruptHandler=theHandlerFunction;
}
