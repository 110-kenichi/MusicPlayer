...
;--------------------------------------------------------
	.area _CODE
;SMSlib_UNSAFE_zx7.c:10: void UNSAFE_SMS_loadZX7compressedTilesatAddr (const void *src, unsigned int dst) {
;	---------------------------------
; Function UNSAFE_SMS_loadZX7compressedTilesatAddr
; ---------------------------------
_UNSAFE_SMS_loadZX7compressedTilesatAddr::
;SMSlib_UNSAFE_zx7.c:166: __endasm;
	pop	bc
